...
public class OI {
    ...
    public OI() {
        ...
        logitech1 = new Joystick(0);
        
        stick_Right = new JoystickButton(logitech1, 12);
        stick_Right.whileHeld(new AutonomousCommand());
        stick_Left = new JoystickButton(logitech1, 11);
        stick_Left.whileHeld(new AutonomousCommand());
        button_Start = new JoystickButton(logitech1, 10);
        button_Start.whileHeld(new AutonomousCommand());
        button_Back = new JoystickButton(logitech1, 9);
        button_Back.whileHeld(new AutonomousCommand());
        trigger_Right = new JoystickButton(logitech1, 8);
        trigger_Right.whileHeld(new AutonomousCommand());
        trigger_Left = new JoystickButton(logitech1, 7);
        trigger_Left.whileHeld(new AutonomousCommand());
        bumper_Right = new JoystickButton(logitech1, 6);
        bumper_Right.whileHeld(new AutonomousCommand());
        bumper_Left = new JoystickButton(logitech1, 5);
        bumper_Left.whileHeld(new AutonomousCommand());
        button_Y = new JoystickButton(logitech1, 4);
        button_Y.whileHeld(new AutonomousCommand());
        button_B = new JoystickButton(logitech1, 3);
        button_B.whileHeld(new AutonomousCommand());
        button_A = new JoystickButton(logitech1, 2);
        button_A.whileHeld(new AutonomousCommand());
        button_X = new JoystickButton(logitech1, 1);
